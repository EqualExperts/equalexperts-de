                ...
                <nav className={`header__navigation`}>
                    {props.navLinks.map(item => {
                      if(item.navItemUrl.indexOf("#") !== -1) {
                        return (<a href={props.homeLink+item.navItemUrl} key={`navItem_${item.navItemUrl}`} className={`header__navigation-link`}>{item.navItemText}</a>);
                      } else {
                        return (<Link to={props.homeLink+item.navItemUrl} key={`navItem_${item.navItemUrl}`} className={`header__navigation-link`}>{item.navItemText}</Link>);
                      }
                    })}
